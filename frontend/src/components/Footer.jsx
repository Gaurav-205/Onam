...
const Footer = ({ scrollToSection }) => {
  ...
  return (
    <footer className="bg-gray-900 text-white text-center py-16">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="w-full max-w-2xl mx-auto h-px bg-gray-600 mb-8"></div>

        {/* Secondary Navigation Links */}
        <div className="flex justify-center space-x-6 md:space-x-8 mb-8 flex-wrap">
          {secondaryLinks.map((link, index) => (
            <button
              key={index}
              onClick={() => scrollToSection(link.id)}
              className="text-gray-300 hover:text-yellow-400 transition-colors duration-200 font-medium tracking-wide text-sm"
            >
              {link.label}
            </button>
          ))}
        ...
        <div className="flex justify-center space-x-6 mb-8">
          ...
          >
            ...
            <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-2 py-1 bg-gray-800 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap z-10">
              LinkedIn
              <div className="absolute top-full left-1/2 transform -translate-x-1/2 w-0 h-0 border-l-4 border-transparent border-t-gray-800"></div>
            </div>
          </a>
        </div>

        {/* Contact Information */}
        <div className="flex justify-center space-x-8 mb-8 text-gray-300">
          <a 
            href="mailto:info@onamfestival.com" 
          ...
          >
            ...
            <span>gauravkhadelwal205@gmail.com</span>
          </a>
          <a 
