      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-200">
            ...
            <h3 className="text-xl font-bold text-gray-800 mb-3 font-heading">Festivals</h3>
            ...
            <div className="inline-flex items-center text-sm text-purple-600 font-medium">
              <span className="bg-purple-100 px-3 py-1 rounded-full">In Development</span>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-200">
            ...
            <h3 className="text-xl font-bold text-gray-800 mb-3 font-heading">Rituals</h3>
            <p className="text-gray-600 mb-4 font-sans">
            ...
            <div className="inline-flex items-center text-sm text-orange-600 font-medium">
              <span className="bg-orange-100 px-3 py-1 rounded-full">In Development</span>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-200">
            ...
            <h3 className="text-xl font-bold text-gray-800 mb-3 font-heading">Memories</h3>
            <p className="text-gray-600 mb-4 font-sans">
            ...
            <div className="inline-flex items-center text-sm text-green-600 font-medium">
              <span className="bg-green-100 px-3 py-1 rounded-full">In Development</span>
            </div>
          </div>
        </div>
